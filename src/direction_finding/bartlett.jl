"""
bartlett(am::AbstractArrayManifold, Rxx, angles; W=nothing, c=c_0)
...
arguments:
----------
    am: AbstractArrayManifold to calculate the estimator for
...
"""
function bartlett(am::AbstractArrayManifold, Rxx, angles, f, c=c_0; W=I, kwargs...)
