"""
sml(am::AbstractArrayManifold, Rxx, DoAs, f; c=c_0, coords=:azel, optimizer=NelderMead(), maxiters=1e3)
...
arguments:
----------
    am: Array (Manifold) to calculate the sml estimator for
...
"""
function sml(am::AbstractArrayManifold, Rxx, DoAs, f, c=c_0;
